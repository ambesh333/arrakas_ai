...
export default function JoinNowCard({ onClose, onJoinClick }: JoinNowCardProps) {
  return (
    <div className="w-full max-w-sm rounded-2xl p-4 space-y-4">
      ...
      <div className="rounded-xl bg-[#1a1a1a] p-6 flex flex-col items-center space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400 mt-1">All-in-one DeFi & IDO platform</p>
        </div>
        <button
          onClick={onJoinClick}
